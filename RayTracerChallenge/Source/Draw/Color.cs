namespace RT.Source.Draw
{
    public class Color
    {
        ...
        public override string ToString() => $"{To255Format(r)} {To255Format(g)} {To255Format(b)}";

        private static int To255Format(float colorValue) => Math.Clamp((int)(colorValue * 255), 0, 255);
